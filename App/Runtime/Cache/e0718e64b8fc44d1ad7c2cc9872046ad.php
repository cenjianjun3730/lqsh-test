        ...
        <div class="admin-navbar">
            ...
            <ul class="nav nav-inline admin-nav">
                ...
                <li class="active"><a href="<?php echo U('dynamic');?>">动态</a>
                    <ul>
                        <li style="background: #09c"><a href="<?php echo U(dynamic);?>">添加动态</a></li>
                        <li><a href="<?php echo U('dynamic', array('c' => 'man'));?>">动态管理</a></li>
                    </ul>
                </li>
    ...
    <div class="tab">
      <div class="tab-body">
        ...
        <div class="tab-panel active" id="tab-set">
            <form method="post" class="form-x" action="<?php echo U('dynamicupdata');?>"  enctype="multipart/form-data">
                <div class="form-group">
                    <div class="label"><label for="sitename">动态标题</label></div>
                    <div class="field">
                        <input type="text" class="input" id="sitename" name="name" size="50" placeholder="动态标题" data-validate="required:请填写动态标题" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="label"><label for="readme">动态类型</label></div>
                    <div class="field">
                ...
                <div class="form-group">
                    <div class="label"><label for="readme">动态内容</label></div>
                    <div class="field">
                        <textarea name="text" class="input" placeholder="请填写动态内容" data-validate="required:请填写动态内容" style="height:250px;"></textarea>
                    </div>
                </div>
                <div class="form-group">
