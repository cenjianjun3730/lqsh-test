    ...
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            ...
            <a onclick="{if(confirm('确认删除?')){return true;}return false;}">
                ...
                <input type="submit" class="button button-small border-blue" value="设置精选产品" onclick="javascript:this.form.action='<?php echo U('proset');?>'" />
        </div>
        <table class="table table-hover">
            ...
            <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                    ...
                    <td>
                        <a class="button border-blue button-little" href="<?php echo U('pro', array('c' => 'mod', 'id' => $v['id']));?>">修改</a>
