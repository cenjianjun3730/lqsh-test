...
<div class="admin">
    <form action="<?php echo U('dynamicdelete');?>" method="post">
    <div class="panel admin-panel">
        ...
        <table class="table table-hover">
            ...
            <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                    ...
                    <td><?php echo ($v["dynamic_name"]); ?></td>
                    <td><?php echo ($v["dynamic_content"]); ?></td>
                    <td><?php echo (date('Y-m-d', $v["time"])); ?></td>
                    <td>
                        <a class="button border-blue button-little" href="<?php echo U('dynamic', array('c' => 'mod', 'id' => $v['id']));?>">修改</a>
                        <a class="button border-yellow button-little" href="<?php echo U('dynamicdeleteone', array('id' => $v['id']));?>" onclick="{if(confirm('确认删除?')){return true;}return false;}">删除</a>
                    </td>
