    ...
    <div class="mainer">
        <div class="admin-navbar">
            ...
            <ul class="nav nav-inline admin-nav">
                ...
                <li class="active"><a href="<?php echo U('dynamic');?>">动态</a>
                    <ul>
                        <li><a href="<?php echo U(dynamic);?>">添加动态</a></li>
                        <li style="background: #09c"><a href="<?php echo U('dynamic', array('c' => 'man'));?>">动态管理</a></li>
                    </ul>
                </li>
    ...
    <div class="tab">
      <div class="tab-body">
        ...
        <div class="tab-panel active" id="tab-set">
            <form method="post" class="form-x" action="<?php echo U('dynamicmodify');?>" enctype="multipart/form-data">
                <div class="form-group">
                    <div class="label"><label for="sitename">产品名称</label></div>
                    <div class="field">
                        <input type="text" class="input" id="sitename" name="name" size="50" placeholder="产品名称" data-validate="required:请填写你产品介绍" value="<?php echo ($data["0"]["dynamic_name"]); ?>"/>                        
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <textarea name="text" class="input" placeholder="请填写产品介绍" data-validate="required:请填写产品介绍" style="height:250px;"><?php echo ($data["0"]["dynamic_content"]); ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        ...
                        <input type="txt" name="add" style="display: none;" value="<?php echo ($data["0"]["dynamic_img"]); ?>"/>
                    </div>
                </div>
