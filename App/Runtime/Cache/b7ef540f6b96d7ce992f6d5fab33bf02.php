        ...
        <div class="admin-navbar">
            ...
            <ul class="nav nav-inline admin-nav">
                ...
                <li class="active"><a href="<?php echo U('pro');?>">产品</a>
                    <ul>
                        <li style="background: #09c"><a href="<?php echo U(pro);?>">添加产品</a></li>
                        <li><a href="<?php echo U('pro', array('c' => 'man'));?>">产品管理</a></li>
                    </ul>
                </li>                
    ...
    <div class="tab">
      <div class="tab-body">
        ...
        <div class="tab-panel active" id="tab-set">
            <form method="post" class="form-x" action="<?php echo U('proupdata');?>" enctype="multipart/form-data">
                <div class="form-group">
                    <div class="label"><label for="sitename">产品名称</label></div>
                    <div class="field">
                        <input type="text" class="input" id="sitename" name="name" size="50" placeholder="产品名称" data-validate="required:请填写产品名称" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <textarea name="text" class="input" placeholder="请填写产品介绍" data-validate="required:请填写产品介绍" style="height:250px;"></textarea>
                    </div>
                </div>
                <div class="form-group">
