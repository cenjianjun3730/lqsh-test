    ...
    <div class="mainer">
        <div class="admin-navbar">
            ...
            <ul class="nav nav-inline admin-nav">
                ...
                <li><a href="<?php echo U('pro');?>">产品</a>        
                <li><a href="<?php echo U('dynamic');?>">动态</a></li>
                <li class="active"><a href="<?php echo U('message');?>">信息</a>
                    <ul>
                        <li style="background: #09c"><a href="<?php echo U('message');?>">查看信息</a></li>
                    </ul>
                </li>
...
<div class="admin">
    <form action="<?php echo U('meshandle');?>" method="post">
    <div class="panel admin-panel">
        ...
        <table class="table table-hover">
            ...
            <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                    ...
                    <td>
                        <a class="button border-yellow button-little" href="<?php echo U('meshandleone', array('id' => $v['id']));?>" onclick="{if(confirm('确认删除?')){return true;}return false;}">删除</a>
                    </td>
