    ...
    <div class="line">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="media media-y">
                <img src="__PUBLIC__/img/logo.jpg" class="radius" alt="后台管理系统" />
            </div>
            <br /><br />
                ...
                <div class="panel-body" style="padding:30px;">
                    <div class="form-group">
                        <div class="field field-icon-right">
                            <input type="text" class="input" name="username" placeholder="登录账号" data-validate="required:请填写账号,length#>=8:账号长度不符合要求" />
